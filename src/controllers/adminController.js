...
class AdminController {
  async getAirlineDetails(req, res, next) {
    try {
      ...
      const data = await adminService.getAirlineDetails(parseInt(airlineId));
      return sendSuccess(res, "Airline details retrieved successfully", data);
    } catch (error) {
  ...
  async getAirlines(req, res, next) {
    try {
      ...
      const { search, airline_code, airline_name, country_id, is_active } =
        req.query;
  ...
  async createAirline(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Airline created successfully", newAirline, 201);
    } catch (error) {
  ...
  async updateAirline(req, res, next) {
    try {
      ...
      try {
        ...
        if (err instanceof NotFoundError || /not found/i.test(err.message)) {
          try {
            ...
            logger.warn("Direct Airline.findByPk lookup failed:", lookupErr);
          }
  ...
  async updateAirlineServicePackages(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Service packages updated successfully", data);
    } catch (error) {
      logger.error("Error in updateAirlineServicePackages controller:", error);
      next(error);
    }
  }
  ...
  async createAirport(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Airport created successfully", newAirport, 201);
    } catch (error) {
  ...
  async updateAirport(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Airport updated successfully", updatedAirport);
    } catch (error) {
  ...
  async getCountries(req, res, next) {
    try {
      ...
      const result = await adminService.getCountries(filters, page, limit);
      return sendPaginated(
        res,
  ...
  async createCountry(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Country created successfully", newCountry, 201);
    } catch (error) {
  ...
  async updateCountry(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Country updated successfully", updatedCountry);
    } catch (error) {
  ...
  async getAircraftById(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Aircraft retrieved successfully", aircraft);
    } catch (error) {
  ...
  async updateAircraft(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Aircraft updated successfully", updatedAircraft);
    } catch (error) {
  ...
  async getPassengers(req, res, next) {
    try {
      ...
      const result = await adminService.getPassengers(filters, page, limit);
      return sendPaginated(
        res,
  ...
  async getPassenger(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Passenger retrieved successfully", passenger);
    } catch (error) {
  ...
  async createPassenger(req, res, next) {
    try {
      ...
      const newPassenger = await adminService.createPassenger(passengerData);
      return sendSuccess(
        res,
  ...
  async getPromotions(req, res, next) {
    try {
      const page = parseInt(req.query.page) || 1;
      const limit = parseInt(req.query.limit) || 10;
      const { search, promotion_code, description, discount_type, is_active } =
        req.query;
      ...
      const result = await adminService.getPromotions(filters, page, limit);
      return sendPaginated(
        res,
  ...
  async createPromotion(req, res, next) {
    try {
      ...
      const newPromotion = await adminService.createPromotion(promotionData);
      return sendSuccess(
        res,
        ...
        try {
          if (currentBooking && currentBooking.contact_email) {
            if (
              ...
              status === "cancelled" &&
              typeof emailService.sendCancellationNotification === "function"
            ) {
              ...
              updatedBooking &&
              updatedBooking.status === "cancellation_rejected" &&
              typeof emailService.sendCancellationRejection === "function"
            ) {
              // Determine rejection reason (prefer explicit reject_reason)
          ...
          logger.warn("Failed to send admin status update email:", emailErr);
        }
        return sendSuccess(
          res,
  ...
  async exportAirlineMarketShareExcel(req, res, next) {
    try {
      ...
      logger.error("Error in exportAirlineMarketShareExcel controller:", error);
      next(error);
    }
  }
  ...
  async exportBookingStatisticsExcel(req, res, next) {
    try {
      const period = req.query.period || "month";
      const stats = await adminService.getBookingStatistics(period);
      const excelBuffer = ExcelExportService.exportBookingStats(stats, period);
      ...
      logger.error("Error in exportBookingStatisticsExcel controller:", error);
      next(error);
    }
  }
  ...
  async getBaggageServiceStatistics(req, res, next) {
    try {
      const period = req.query.period || "month";
      const stats = await adminService.getBaggageServiceStatistics(period);
      return sendSuccess(
        res,
      ...
      logger.error("Error in getBaggageServiceStatistics controller:", error);
      next(error);
    }
  }
  ...
  async getTravelClasses(req, res, next) {
    try {
      ...
      const result = await adminService.getTravelClasses(filters, page, limit);
      return sendPaginated(
        res,
  ...
  async getBaggageOptions(req, res, next) {
    try {
      ...
      const result = await adminService.getBaggageOptions(filters, page, limit);
      return sendPaginated(
        res,
  ...
  async getBaggageOption(req, res, next) {
    try {
      const { id } = req.params;
      const baggageOption = await adminService.getBaggageOption(parseInt(id));
      return sendSuccess(
        res,
  ...
  async getMealOptions(req, res, next) {
    try {
      ...
      const result = await adminService.getMealOptions(filters, page, limit);
      return sendPaginated(
        res,
  ...
  async getMealOption(req, res, next) {
    try {
      ...
      return sendSuccess(res, "Meal option retrieved successfully", mealOption);
    } catch (error) {
  ...
  async createMealOption(req, res, next) {
    try {
      ...
      const newMealOption = await adminService.createMealOption(mealOptionData);
      return sendSuccess(
        res,
  ...
  async getAllFlights(req, res, next) {
    try {
      ...
      if (departure_airport_code) {
        ...
        if (departureAirport)
          whereClause.departure_airport_id = departureAirport.airport_id;
      }
      ...
      const enhancedFlights = await Promise.all(
        flights.map(async (flight) => {
          ...
          flight.FlightSeats.forEach((seat) => {
            const classCode = seat.TravelClass?.class_code?.toLowerCase();
    ...
    try {
      ...
      if (departure_date) {
        ...
        if (parts.length >= 3 && parts.every((n) => !isNaN(n))) {
          ...
          const startUtcMs =
            Date.UTC(y, m - 1, d, 0, 0, 0) - TZ_OFFSET_HOURS * 3600 * 1000;
          ...
          // invalid date format
          return sendError(res, "departure_date must be in YYYY-MM-DD format");
        }
      } else {
        if (departure_time_from)
          filters.departure_time_from = departure_time_from;
        if (departure_time_to) filters.departure_time_to = departure_time_to;
      }
      if (arrival_time_from) filters.arrival_time_from = arrival_time_from;
